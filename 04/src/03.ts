...
// console.log(mechanic.technicalInspection(notACar));
// console.log(mechanic.technicalInspection(maybeCar));
// console.log(mechanic.technicalInspection(maybeCar3));
// console.log(mechanic.technicalInspection(maybeCar5));
